...
\begin{scoreDescription}
  \score{30} Se probarán varios casos donde todos los hombres son de la misma estatura y todas las mujeres son de la misma estatura.
  \score{30} Se probarán varios casos donde para cada mujer existe un hombre de la misma estatura.
  \score{40} Se probarán varios casos donde no hay restricciones adicionales.
