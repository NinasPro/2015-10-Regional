...
Puedes poner las instrucciones que desees dentro incluso más instrucciones condicionales anidadas.
...
\end{minipage}
\begin{minipage}{0.45\linewidth}
En esta subtarea debes resolver el laberinto usando \textbf{sólo una instrucción `repetir' y no más de 5 instrucciones `avanzar'}.
\end{minipage}
